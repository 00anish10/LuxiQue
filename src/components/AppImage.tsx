...
const AppImage = () => {
  return (
    <div className="relative">
      <div className="w-full max-w-[220px] mx-auto relative z-10">
        <div className="rounded-[32px] overflow-hidden border-6 border-black shadow-lg">
          <img 
            src="/public/img.png" 
            alt="LuxiQue App Interface" 
        ...
        <div className="absolute -right-2 top-10 z-20 animate-bounce-subtle" style={{ animationDelay: '1s' }}>
          <div className="bg-white rounded-full p-2 shadow-lg animate-pulse-glow">
      ...
      {/* Animated icons replacing emoji faces */}
      <div className="hidden md:block absolute top-0 right-0 animate-float-smooth" style={{ animationDelay: '0.2s' }}>
        <div className="rounded-full w-10 h-10 bg-luxury-purple flex items-center justify-center text-white shadow-lg">
      ...
      <div className="hidden md:block absolute bottom-20 left-20 animate-float-smooth" style={{ animationDelay: '0.7s' }}>
        <div className="rounded-full w-10 h-10 bg-luxury-purple flex items-center justify-center text-white shadow-lg animate-pulse-glow">
